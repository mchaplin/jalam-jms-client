...
public class DefaultLifecycleController implements LifecycleControllerInterface {
    ...
    * Finally, choose the first class found as the listener class (defaulting if needed)
    * TODO: SMM Add support for multiple listeners (this requires linking a listener to it's jms destinations).
    * 
    * @param props
    * @throws ResourceInitializerException if any of the listenerClasses supplied could not be found.
    */
   ...
   /**
    * Recover the jms.properties file which should be stored in the conf directory
    * TODO: Add support for supplying the location of the jms.properties.
    * @return 
    */
