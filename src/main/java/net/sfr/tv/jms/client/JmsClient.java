...
public class JmsClient implements Runnable {
    ...
    * @param lifecycleControllerClassName name of the LifecycleController class -- In Jalam 1.0 this can be used as the JMS listener class name
    ...
    *
    * @param className The name of the LifecycleController class to load and use. Note: Jalam 1.0 uses this as the MessageListenerWrapper class name.
