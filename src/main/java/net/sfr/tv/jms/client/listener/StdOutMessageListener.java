 ...
 */
public class StdOutMessageListener implements MessageListenerWrapper {

    private final Logger LOGGER = Logger.getLogger(StdOutMessageListener.class);

    private String name;
    
    public StdOutMessageListener() {
        name = StdOutMessageListener.class.getName();
    }
